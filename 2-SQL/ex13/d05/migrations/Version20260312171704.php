 ...
 */
final class Version20260312171704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, birthdate DATETIME NOT NULL, active TINYINT NOT NULL, employed_since DATETIME NOT NULL, employed_until DATETIME NOT NULL, hours VARCHAR(255) NOT NULL, salary INT NOT NULL, position VARCHAR(255) NOT NULL, manager_id INT DEFAULT NULL, INDEX IDX_5D9F75A1783E3463 (manager_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8');
